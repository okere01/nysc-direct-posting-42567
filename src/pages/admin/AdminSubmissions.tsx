              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-muted/50">
                    ...
                    <TableHead className="font-semibold">State (Origin)</TableHead>
                    <TableHead className="font-semibold">State (Choice)</TableHead>
                ...
                <TableBody>
                  {filteredSubmissions.map((submission) => (
                    <TableRow key={submission.id} className="hover:bg-muted/30">
                      ...
                      <TableCell className="max-w-[200px] truncate">{submission.nysc_email || "N/A"}</TableCell>
                      <TableCell>
                        {submission.nysc_password ? "••••••••" : "N/A"}
                      </TableCell>
                      <TableCell>
                        ...
                        <Dialog>
                          ...
                          <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                Update submission status and payment verification
                              </DialogDescription>
                            </DialogHeader>
                            ...
                            {selectedSubmission && (
                              <div className="space-y-6 py-4">
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-2 gap-4 bg-muted/50 rounded-lg border p-4">
                                    <div>
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-2 gap-4 bg-muted/50 rounded-lg border p-4">
                                    <div>
                                      ...
                                      <p className="font-medium">{selectedSubmission.nysc_email || "Not provided"}</p>
                                    </div>
                                    <div>
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="space-y-4 bg-muted/50 rounded-lg border p-4">
